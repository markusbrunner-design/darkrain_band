...
<!-- Haftungsausschluss -->
	...
	<p class="inhalt1">
		...
		des Autors kein nachweislich vors&auml;tzliches oder grob fahrl&auml;ssiges
	...
	<p class="inhalt1">
		...
		ohne gesonderte Ank&uuml;ndigung zu ver&auml;ndern, zu erg&auml;nzen, zu l&ouml;schen
		oder die Ver&ouml;ffentlichung zeitweise oder endg&uuml;ltig einzustellen.
	</p>
	<h2>
	...
	<p class="inhalt1">
		...
		gesetzten Links und Verweise sowie f&uuml;r Fremdeintr&auml;ge in vom Autor
		eingerichteten G&auml;steb&uuml;chern, Diskussionsforen, Linkverzeichnissen,
		...
		fehlerhafte oder unvollst&auml;ndige Inhalte und insbesondere f&uuml;r
		...
		Seite, auf welche verwiesen wurde, nicht derjenige, der &uuml;ber Links
		auf die jeweilige Ver&ouml;ffentlichung lediglich verweist.
	</p>
	<h2>
	...
	<p class="inhalt1">
		...
		ohne ausdr&uuml;ckliche Zustimmung des Autors nicht gestattet.
	</p>
	<h2>
		4. Datenschutz
	</h2>
	<p class="inhalt1">
		...
		des Nutzers auf ausdr&uuml;cklich freiwilliger Basis. Die
		...
		Faxnummern sowie Emailadressen durch Dritte zur &uuml;bersendung von
		nicht ausdr&uuml;cklich angeforderten Informationen ist nicht gestattet.
		Rechtliche Schritte gegen die Versender von sogenannten Spam-Mails
		bei Verst&ouml;&szlig;en gegen dieses Verbot sind ausdr&uuml;cklich vorbehalten.
	</p>
	<h2>
	...
	<p class="inhalt1">
		...
		sollten, bleiben die &uuml;brigen Teile des Dokumentes in ihrem Inhalt
