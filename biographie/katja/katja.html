<?php include '../../include/head.php'; ?>
	...
	<table border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="375" class="inhalt1">jegliche Art von Nudeln, am besten mit K�se �berbacken</td>
		</tr>
		<tr class="bggrau">
		...
		<tr>
			...
			<td width="375" class="inhalt1">Nackte Kanone, Hot Shots, Ace Ventura, Eine sch�ne Bescherung, Sieben, Schweigen der L�mmer, kurz gesagt: Kom�dien, Psychothriller, Horror</td>
		</tr>
		<tr class="bggrau">
		...
		<tr class="bggrau">
			...
			<td width="375" class="inhalt1">anderen zuh�ren, rumgrummeln, f�r andere da sein, gut drauf sein und �ber alles lachen (wie Dr. Hibbert von den Simpsons)</td>
		</tr>
		<tr>
			<td width="125" class="inhalt1bold">Ich kann nicht:</td>
			<td width="375" class="inhalt1">singen, r�ckw�rts einparken</td>
		</tr>
		<tr class="bggrau">
